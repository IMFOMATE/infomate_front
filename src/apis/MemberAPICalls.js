...
export const callGetMemberAPI = ({memberId}) => {
    const requestURL = `http://localhost:8989/api/v1/members/${memberId}`;
...
export const callLoginAPI = ({form}) => {
    const requestURL = `http://localhost:8989/auth/login`;
...
export const callRegisterAPI = ({form}) => {
    const requestURL = `http://localhost:8989/auth/signup`;
