...
function MailReferenceModal({ isOpen, closeModal, contact , setReference, reference}) {
    ...
    const handleSelectChange =  (e) => {
        ...
        setReference(prevContacts => [...prevContacts, selectedContact]); 
    };
    ...
    const onDeleteContact = (contact) => {
        ...
        const updateSelected = reference.filter(item => item.contactName !== contact.contactName);

        setReference(updateSelected);
